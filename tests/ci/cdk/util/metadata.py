...
AWS_ACCOUNT = EnvUtil.get("CDK_DEPLOY_ACCOUNT", "158043403898")
AWS_REGION = EnvUtil.get("CDK_DEPLOY_REGION", "us-east-1")
...
GITHUB_REPO_OWNER = EnvUtil.get("GITHUB_REPO_OWNER", "amirhosv")
